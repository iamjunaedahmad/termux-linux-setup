...
```bash
curl -O https://raw.githubusercontent.com/iamjunaedahmad/termux-linux-setup/main/termux-linux-setup.sh && chmod +x termux-linux-setup.sh && ./termux-linux-setup.sh
```
